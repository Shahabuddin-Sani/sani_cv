...
import 'package:sani_cv/configs/configs.dart';
...
class AppText {
  ...
  static init() {
    ...
    const baseStyleLogo = TextStyle(fontFamily: "Anton");

    logoStyle =
        baseStyleLogo.copyWith(fontSize: AppDimensions.font(15), fontWeight: b);
